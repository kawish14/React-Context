...
export default class NorthSelectGraphic extends React.Component{
...
componentDidMount(){
    ...
    north.when(function(){
        view.whenLayerView(north).then(function (layerView) {
            _this.setState({
...
selectFeatures = (geometry) =>{
    ...
    if (_this.state.northLayerView && north.visible === true) {
            ...
            if (results.features.length === 0) {
               ...
               return null
                ...
                _this.setState({
                    ...
                    northCPEnav:true,
                    selectionTable:true,
                    northCPEHighlight:_this.state.northLayerView.highlight(results.features),
