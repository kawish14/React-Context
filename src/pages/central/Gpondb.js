      ...
      {props.summaryTableFun ? null : (
       ...
       <table
        ...
        >
          ...
          <tbody>
            <tr>
              <td className="col-md-2">Center</td>
              ...
              <td className="col-md-2"> {props.centralStatus.centralOnline}</td>
              <td className="col-md-2">
                {props.centralStatus.centralDyingGasp}
              </td>
              <td className="col-md-2">{props.centralStatus.centralGEMPack}</td>
              <td className="col-md-2">{props.centralStatus.centralLOP}</td>
              <td className="col-md-2">{props.centralStatus.ticketCentral}</td>
            </tr>
          </tbody>
        </table>
